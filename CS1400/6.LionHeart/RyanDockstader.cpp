...
#include <random>
#include <iostream>
/* Rest of this project found at https://github.com/ksundberg/CS1400/tree/master/projects/lionheart*/
...
bool lionheart::RyanDockstader::checkForCrown(lionheart::Unit const &unit, lionheart::SituationReport report)
{//fix this so it will actually check for the crown?
	...
	for ( r; r < rowPlusFive; ++r)
	{
		for (c; c < colPlusFive; ++c)
		{
